...
public:
	 ...
	 */
        Mesh(Real_t _Area) noexcept;
	Mesh(Real_t* _Boundary, int32_t _nBoundary, Real_t* _PML, int32_t _nPML, Real_t _Area) noexcept;
	/*
	 *  virtual ~Mesh()
	 *
	 *  Destroy Mesh object.
...
private:
	void construct(Real_t* _Boundary, int32_t _nBoundary, Real_t* _PML, int32_t _nPML, Real_t _Area) noexcept;
